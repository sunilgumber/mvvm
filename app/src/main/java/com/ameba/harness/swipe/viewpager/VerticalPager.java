package com.ameba.harness.swipe.viewpager;
...
public class VerticalPager extends ViewGroup {
	...
	private VerticalPageListener verticalPageListener;
	...
	private void snapToPage(final int whichPage, final int where, int duration) {
		verticalPageListener.pageselected(whichPage);
		if(whichPage==0)
			mScrollable=false;
		else
			mScrollable=true;
	...
	public void setPageCallback(VerticalPageListener verticalPageListener) {
		this.verticalPageListener=verticalPageListener;
	}
