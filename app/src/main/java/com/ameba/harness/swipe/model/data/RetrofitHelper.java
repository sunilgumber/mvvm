package com.ameba.harness.swipe.model.data;




import com.ameba.harness.swipe.model.entity.Movie;
import com.ameba.harness.swipe.model.entity.Response;
...
public class RetrofitHelper {
    ...
    public void getMovies(Subscriber<Movie> subscriber, int start, int count) {
        movieService.getMovies(start, count).map(new Func1<Response<List<Movie>>, List<Movie>>() {
                    @Override
